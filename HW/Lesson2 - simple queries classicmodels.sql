...
-- EER or ER or ERD Diagram (Enhanced Entity Relationship Diagram) 
-- Database - Reverse Engineer - Next - Enter Password - Next - Choose Database - Next - Next - Execute - Finish
...
-- show payments from year 2005 and up
